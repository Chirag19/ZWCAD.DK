========================================================================
    ACTIVE TEMPLATE LIBRARY : ZwInteBase Project Overview
========================================================================

AppWizard has created this ZwInteBase project for you to use as the starting point for
...
ZwInteBase.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ZwInteBase.h)
        GUID definitions                                (ZwInteBase_i.c)
        A type library                                  (ZwInteBase.tlb)
        Marshaling code                                 (ZwInteBase_p.c and dlldata.c)

ZwInteBase.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ZwInteBase.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ZwInteBase.pch and a precompiled types file named StdAfx.obj.
...
ZwInteBaseps.vcproj
	...
	dlldata.c, ZwInteBase_i.c and ZwInteBase_p.c which are required

...
public:
	...
	Zdesk::Boolean setInterval(const ZcGeInterval& intrvl);
	...
	Zdesk::Boolean getNormalPoint(const ZcGePoint3d& pnt,
	                              ZcGePointOnCurve3d& pntOnCrv,
                                      const ZcGeTol& tol = ZcGeContext::gTol) const;
    ...
    Zdesk::Boolean isClosed      (const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean isPlanar      (ZcGePlane& plane,
                                  const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean isLinear      (ZcGeLine3d& line,
                                  const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean isCoplanarWith(const ZcGeCurve3d& curve3d,
                                  ZcGePlane& plane,
                                  const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean isPeriodic    (double& period) const;
    ...
    double         paramAtLength(double datumParam, double length,
                                 Zdesk::Boolean posParamDir = Zdesk::kTrue,
                                 double tol = ZcGeContext::gTol.equalPoint()) const;
    Zdesk::Boolean area         (double startParam, double endParam,
                                 double& value,
                                 const ZcGeTol& tol = ZcGeContext::gTol) const;

    
    Zdesk::Boolean isDegenerate(ZcGe::EntityId& degenerateType,
                                const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean isDegenerate(ZcGeEntity3d*& pConvertedEntity,
                                const ZcGeTol& tol = ZcGeContext::gTol) const;
	...
	Zdesk::Boolean explode       (ZcGeVoidPointerArray& explodedCurves,
    ...
    Zdesk::Boolean hasStartPoint(ZcGePoint3d& startPnt) const;
    Zdesk::Boolean hasEndPoint  (ZcGePoint3d& endPnt) const;

...
extern __declspec(selectany) const ZCHAR kBackslash =  ZCRX_T( '\\' );
extern __declspec(selectany) const ZCHAR kColon =      ZCRX_T( ':' );
extern __declspec(selectany) const ZCHAR kDoubleQuote= ZCRX_T( '"' );
extern __declspec(selectany) const ZCHAR kEOS =        ZCRX_T( '\0' );
extern __declspec(selectany) const ZCHAR kPeriod =     ZCRX_T( '.' );
extern __declspec(selectany) const ZCHAR kSlash =      ZCRX_T( '/' );
extern __declspec(selectany) const ZCHAR kSpace =      ZCRX_T( ' ' );
extern __declspec(selectany) const ZCHAR kAsterisk =   ZCRX_T( '*' );
extern __declspec(selectany) const ZCHAR kQuestionmark = ZCRX_T( '?' );   
extern __declspec(selectany) const ZCHAR kZero =       ZCRX_T( '0' );
...
public:
    ...
    virtual BOOL VolMatch( const ZCHAR * a, const CString* b ) const;

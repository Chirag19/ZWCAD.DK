...
public:
    ...
    Zdesk::Boolean    contains         (const ZcGePoint3d& point) const;
    Zdesk::Boolean    isDisjoint       (const ZcGeBoundBlock3d& block) const;

   
    ZcGeBoundBlock3d& operator =       (const ZcGeBoundBlock3d& block);

    Zdesk::Boolean     isBox    () const;
    ZcGeBoundBlock3d&  setToBox (Zdesk::Boolean);
};

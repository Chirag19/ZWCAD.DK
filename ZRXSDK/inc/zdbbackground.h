...
const ZCHAR ZCDB_BACKGROUND_DICTIONARY[]  = /*MSG0*/ZCRX_T("ZCAD_BACKGROUND");
...
public:
    ...
    void            setImageFilename        (const ZCHAR* filename);
    const ZCHAR *   imageFilename           (void) const;

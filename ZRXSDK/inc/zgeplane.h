...
public:
    ...
    Zdesk::Boolean intersectWith    (const ZcGeLinearEnt3d& linEnt, ZcGePoint3d& resultPnt,
                                     const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean intersectWith    (const ZcGePlane& otherPln, ZcGeLine3d& resultLine,
                                     const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean intersectWith    (const ZcGeBoundedPlane& bndPln, ZcGeLineSeg3d& resultLineSeg,
                                     const ZcGeTol& tol = ZcGeContext::gTol) const;

...
public:
    ...
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setNumRows(int nRows);

    virtual Zdesk::UInt32       numColumns() const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setNumColumns(int nCols);
    ...
    ZDESK_DEPRECATED virtual double horzCellMargin() const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setHorzCellMargin(double gap);

    ZDESK_DEPRECATED virtual double vertCellMargin() const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setVertCellMargin(double gap);

    virtual ZcDb::FlowDirection flowDirection() const; 
    virtual Zcad::ErrorStatus   setFlowDirection(ZcDb::FlowDirection flow);

    ZDESK_DEPRECATED virtual bool isTitleSuppressed() const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus suppressTitleRow(bool value);

    ZDESK_DEPRECATED virtual bool isHeaderSuppressed() const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus suppressHeaderRow(bool value);

    ZDESK_DEPRECATED virtual ZcDb::CellAlignment alignment(ZcDb::RowType type =
                                          ZcDb::kDataRow) const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus   setAlignment(ZcDb::CellAlignment align,
                                          int rowTypes = ZcDb::kAllRows);

    ZDESK_DEPRECATED virtual bool isBackgroundColorNone(ZcDb::RowType type = 
                                          ZcDb::kDataRow) const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setBackgroundColorNone(bool value,
                                          int rowTypes = ZcDb::kAllRows);

    ZDESK_DEPRECATED virtual ZcCmColor backgroundColor(ZcDb::RowType type =
                                          ZcDb::kDataRow) const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setBackgroundColor(const ZcCmColor& color,
                                          int rowTypes = ZcDb::kAllRows);

    ZDESK_DEPRECATED virtual ZcCmColor contentColor(ZcDb::RowType type = 
                                          ZcDb::kDataRow) const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setContentColor(const ZcCmColor& color,
    ...
    ZDESK_DEPRECATED virtual const ZCHAR* format(ZcDb::RowType type);
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setFormat(const ZCHAR* pszFormat);
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setFormat(const ZCHAR* pszFormat, 
                                          int nRowTypes);

    ZDESK_DEPRECATED virtual ZcDbObjectId  textStyle(ZcDb::RowType type =
                                          ZcDb::kDataRow) const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setTextStyle(const ZcDbObjectId& id,
                                          int rowTypes = ZcDb::kAllRows);

    ZDESK_DEPRECATED virtual double textHeight(ZcDb::RowType type =
                                          ZcDb::kDataRow) const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setTextHeight(double height,
                                          int rowTypes = ZcDb::kAllRows);

    ZDESK_DEPRECATED virtual ZcDb::LineWeight gridLineWeight(ZcDb::GridLineType gridlineType,
                                ZcDb::RowType type = ZcDb::kDataRow) const; 
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setGridLineWeight(ZcDb::LineWeight lwt,
                                               int nBorders,
                                               int nRows);

    ZDESK_DEPRECATED virtual ZcCmColor gridColor(ZcDb::GridLineType gridlineType,
                                ZcDb::RowType type = ZcDb::kDataRow) const; 
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setGridColor(const ZcCmColor& color,
                                               int nBorders,
                                               int nRows);

    ZDESK_DEPRECATED virtual ZcDb::Visibility gridVisibility(ZcDb::GridLineType gridlineType,
                                ZcDb::RowType type = ZcDb::kDataRow) const; 
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setGridVisibility(ZcDb::Visibility visible,
                                               int nBorders,
                                               int nRows);

    ZDESK_DEPRECATED virtual bool tableStyleOverrides(
                                               ZcDbIntArray& overrides) const;
    ZDESK_DEPRECATED virtual void clearTableStyleOverrides(int options = 0);

    virtual ZcDb::CellType      cellType(int row, 
                                         int col) const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setCellType(int row, 
                                         int col,
                                         ZcDb::CellType type);
    ...
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus deleteCellContent(int row, 
                                             int col);
    ZDESK_DEPRECATED virtual ZcDb::RowType rowType(int row) const;
    ...
    const ZCHAR* format(int row, int col) const;
    ZDESK_DEPRECATED Zcad::ErrorStatus setFormat(int row, int col, 
                                                   const ZCHAR* pszFormat);
    virtual const ZCHAR*         textStringConst(int row, 
                                                int col) const;
    virtual ZCHAR*               textString(int row, 
                                           int col) const;
    ...
    ZDESK_DEPRECATED virtual ZcDb::RotationAngle textRotation(int row,
                                              int col) const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus  setTextRotation(int row, 
                                              int col,
                                              ZcDb::RotationAngle rot);

    ZDESK_DEPRECATED virtual bool isAutoScale(int row,
                                              int col) const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setAutoScale(int row, 
                                              int col,
                                              bool autoFit);
    ...
    ZDESK_DEPRECATED virtual double blockScale(int row,
                                               int col) const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setBlockScale(int row, 
                                              int col,
                                              double scale);

    ZDESK_DEPRECATED virtual double blockRotation(int row,
                                              int col) const;
    ZDESK_DEPRECATED virtual Zcad::ErrorStatus setBlockRotation(int row, 
                                              int col,
                                              double rotAng);
    ...
    virtual Zdesk::Boolean    worldDraw(ZcGiWorldDraw* worldDraw);
    ...
    Zcad::ErrorStatus setCustomData         (int nRow, 
                                             ...
                                             const ZCHAR* pszKey, 
                                             const ZcValue* pData);
    const ZCHAR *   cellStyle               (int nRow, 
                                             int nCol) const;
    ...
    const ZCHAR *   getColumnName           (int nIndex) const;

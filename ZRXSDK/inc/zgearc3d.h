...
public:
    ...
    Zdesk::Boolean intersectWith  (const ZcGeLinearEnt3d& line, int& intn,
                                   ZcGePoint3d& p1, ZcGePoint3d& p2,
                                   const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean intersectWith  (const ZcGeCircArc3d& arc, int& intn,
                                   ZcGePoint3d& p1, ZcGePoint3d& p2,
                                   const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean  intersectWith (const ZcGePlanarEnt& plane, int& numOfIntersect,
                                   ZcGePoint3d& p1, ZcGePoint3d& p2,
                                   const ZcGeTol& tol = ZcGeContext::gTol) const;
    ...
    Zdesk::Boolean tangent        (const ZcGePoint3d& pnt, ZcGeLine3d& line,
                                   const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean tangent        (const ZcGePoint3d& pnt, ZcGeLine3d& line,
    ...
    Zdesk::Boolean isInside       (const ZcGePoint3d& pnt,
                                   const ZcGeTol& tol = ZcGeContext::gTol) const;

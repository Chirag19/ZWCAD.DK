...
public:
    ...
    ZCDB_PORT ZcValue(const ZCHAR * pszValue);
    ...
    ZCDB_PORT bool  setFormat               (const ZCHAR* pszFormat);

    ZCDB_PORT bool  isValid                 (void) const;

    ZCDB_PORT       operator const ZCHAR *  (void) const;
    ...
    ZCDB_PORT ZcValue& operator=            (const ZCHAR * pszValue);
    ...
    Zdesk::Boolean  isEqualTo               (const ZcRxObject* pOther) const;

    ZCDB_PORT bool  get                     (const ZCHAR *& pszValue) const;
    ZCDB_PORT bool  get                     (ZCHAR *& pszValue) const;
    ...
    ZCDB_PORT bool  set                     (const ZCHAR* pszValue);
    ZCDB_PORT bool  set                     (ZcValue::DataType nDataType, 
                                             const ZCHAR* pszValue);
    ...
    ZCDB_PORT bool  parse                   (const ZCHAR* pszText, 
    ...
    ZCDB_PORT const ZCHAR* format           (void) const;
    ZCDB_PORT ZcString format               (const ZCHAR* pszFormat) const;
    ZCDB_PORT bool  format                  (ZCHAR*& pszValue) const;
    ZCDB_PORT bool  format                  (const ZCHAR* pszFormat, 
                                             ZCHAR*& pszValue) const;
    ZCDB_PORT ZcString format               (ZcValue::FormatOption nOption);
    ZCDB_PORT ZcString format               (const ZCHAR* pszFormat, 

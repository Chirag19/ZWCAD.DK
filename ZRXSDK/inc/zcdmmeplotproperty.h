...
public:
    ...
    void SetNamespace(const wchar_t* ns) 
    {
        ...
        if (NULL != ns) {
            ...
            ::wcscpy_s(m_namespace, ::wcslen(ns) + 1, ns);
        } else {
            m_namespace = NULL;
        }
    }
    ...
    void SetNamespaceUrl(const wchar_t* nsUrl)    
    {
        ...
        if (NULL != nsUrl) {
            ...
            ::wcscpy_s(m_namespaceUrl, ::wcslen(nsUrl) + 1, nsUrl);
        } else {
            m_namespaceUrl = NULL;
        }
    }
    ...
    void SetAttributeName(const wchar_t* attName)
    {
        ...
        if (NULL != attName) {
            ...
            ::wcscpy_s(m_attributeName, ::wcslen(attName) + 1, attName);
        } else {
    ...
    void SetAttributeValue(const wchar_t* attValue)
    {
        ...
        if (NULL != attValue) {
            ...
            ::wcscpy_s(m_attributeValue, ::wcslen(attValue) + 1, attValue);
        } else {
...
public:
    ...
    ZcDMMEPlotProperty(const wchar_t *name, const wchar_t * value)
    {
        ...
        if (NULL != value) {
            ...
            ::wcscpy_s(m_value, ::wcslen(value) + 1, value);
        } else {
            m_value = NULL;
        }    
        m_category = NULL;
    ...
    void SetType(const wchar_t * type)
    {
        ...
        if (NULL != type) {
            ...
            ::wcscpy_s(m_type, ::wcslen(type) + 1, type);
        } else {
            m_type = NULL;
        }    
    }
    ...
    void SetUnits(const wchar_t * units)
    {
        ...
        if (NULL != units) {
            ...
            ::wcscpy_s(m_units, ::wcslen(units) + 1, units);
        } else {
            m_units = NULL;
        }    
    }
    ...
    void SetCategory(const wchar_t * category)
    {
        ...
        if (NULL != category) {
            ...
            ::wcscpy_s(m_category, ::wcslen(category) + 1, category);
        } else {
            m_category = NULL;
        }    
    }

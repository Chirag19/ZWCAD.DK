...
typedef ZcGe::ExternalEntityKind ZExternalEntityKind;
...
typedef ZcGe::NurbSurfaceProperties ZNurbSurfaceProperties;
...
typedef ZcGe::PointContainment ZPointContainment;

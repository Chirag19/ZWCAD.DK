...
inline int ZcIntPtrToInt(Zdesk::LongPtr nVal, Zdesk::LongPtr nLimit = 0x1000000)
{
...
inline unsigned int ZcUIntPtrToUInt(Zdesk::ULongPtr nVal, Zdesk::ULongPtr nLimit = 0x1000000)
{
    Zc64Assert(nVal < nLimit);
...
inline Zdesk::LongPtr __stdcall ZcStrToIntPtr(const wchar_t * s)
{
#ifdef _ZWIN64
    return _wtoi64(s);
#else

...
#define ZCDB_GROUP_DICTIONARY          ZCRX_T("ZCAD_GROUP")
#define ZCDB_MLINESTYLE_DICTIONARY     ZCRX_T("ZCAD_MLINESTYLE")
#define ZCDB_LAYOUT_DICTIONARY         ZCRX_T("ZCAD_LAYOUT")
#define ZCDB_PLOTSETTINGS_DICTIONARY   ZCRX_T("ZCAD_PLOTSETTINGS")
#define ZCDB_PLOTSTYLENAME_DICTIONARY  ZCRX_T("ZCAD_PLOTSTYLENAME")
#define ZCDB_MATERIAL_DICTIONARY       ZCRX_T("ZCAD_MATERIAL")
#define ZCDB_VISUALSTYLE_DICTIONARY    ZCRX_T("ZCAD_VISUALSTYLE")
#define ZCDB_COLOR_DICTIONARY          ZCRX_T("ZCAD_COLOR")
#define ZCDB_TABLESTYLE_DICTIONARY     ZCRX_T("ZCAD_TABLESTYLE")
#define ZCDB_EMBEDDED_OBJECT_STR       ZCRX_T("Embedded Object")
#define ZCDB_LAYERSTATES_DICTIONARY    ZCRX_T("ZCAD_LAYERSTATES")
#define ZCDB_FIELD_DICTIONARY          ZCRX_T("ZCAD_FIELD")
#define ZCDB_FIELDLIST                 ZCRX_T("ZCAD_FIELDLIST")
#define ZCDB_ENHANCED_BLOCK            ZCRX_T("ZCAD_ENHANCEDBLOCK")
#define ZCDB_ENHANCED_BLOCK_EVALKEY    ZCRX_T("ZCAD_ENHANCEDBLOCKEVALKEY")
#define ZCDB_ENHANCED_BLOCK_REF        ZCRX_T("ZCAD_ENHANCEDBLOCK_REFERENCE")
#define ZCDB_SECTION_MANAGER           ZCRX_T("ZCAD_SECTION_MANAGER")
#define ZCDB_DATALINK                  ZCRX_T("ZCAD_DATALINK")
#define ZCDB_ANNOTATIONSCALES_COLLECTION ZCRX_T("ZCDB_ANNOTATIONSCALES")
#define ZCDB_MLEADERSTYLE_DICTIONARY   ZCRX_T("ZCAD_MLEADERSTYLE")
...
struct ZcDb
{
    ...
    typedef Zdesk::UInt32    SubentType;

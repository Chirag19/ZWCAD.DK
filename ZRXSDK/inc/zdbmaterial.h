...
public:
    ...
    virtual Zcad::ErrorStatus   setName (const ZCHAR * pName);
    virtual const ZCHAR *       name    (void) const;

    virtual Zcad::ErrorStatus   setDescription(const ZCHAR * pDescription);
    ...
    Zdesk::Boolean      twoSided                () const;
    Zcad::ErrorStatus   setTwoSided             (Zdesk::Boolean value);
    ...
    Zdesk::Boolean      isAnonymous             () const;
    Zcad::ErrorStatus   setAnonymous            (Zdesk::Boolean isAnonymous);

...
public:
    //{{AFX_VIRTUAL(CZcUiComboBox)
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZcUiComboBox)
    //}}AFX_MSG
    DECLARE_MESSAGE_MAP()
};
...
public:
    //{{AFX_VIRTUAL(CZcUiAngleComboBox)
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZcUiAngleComboBox)
    //}}AFX_MSG
    DECLARE_MESSAGE_MAP()
};
...
public:
    //{{AFX_VIRTUAL(CZcUiNumericComboBox)
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZcUiNumericComboBox)
    //}}AFX_MSG
    DECLARE_MESSAGE_MAP()
};
...
public:
    //{{AFX_VIRTUAL(CZcUiStringComboBox)
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZcUiStringComboBox)
    //}}AFX_MSG
    DECLARE_MESSAGE_MAP()
};
...
public:
    //{{AFX_VIRTUAL(CZcUiSymbolComboBox)
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZcUiSymbolComboBox)
    //}}AFX_MSG
    DECLARE_MESSAGE_MAP()
};
...
public:
    //{{AFX_VIRTUAL(CZcUiMRUListBox)
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZcUiMRUListBox)
    //}}AFX_MSG
...
public:
    //{{AFX_VIRTUAL(CZcUiLineTypeComboBox)
    virtual void DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct);
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZcUiLineTypeComboBox)
    //}}AFX_MSG
...
public:
    //{{AFX_VIRTUAL(CZcUiColorComboBox)
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZcUiColorComboBox)
    //}}AFX_MSG
...
public:
    //{{AFX_VIRTUAL(CZcUiTrueColorComboBox)
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZcUiTrueColorComboBox)
    //}}AFX_MSG
...
public:
    //{{AFX_VIRTUAL(CZcUiLineWeightComboBox)
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZcUiLineWeightComboBox)
    //}}AFX_MSG
...
public:
    //{{AFX_VIRTUAL(CZcUiArrowHeadComboBox)
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZcUiArrowHeadComboBox)
    //}}AFX_MSG
...
class ZCUI_PORT CZcUiPlotStyleTablesComboBox : public CZcUiMRUComboBox {
    ...
    public:
    //{{AFX_VIRTUAL(CZcUiPlotStyleTablesComboBox)
    //}}AFX_VIRTUAL

    protected:
    //{{AFX_MSG(CZcUiPlotStyleTablesComboBox)
    afx_msg BOOL OnDropDown();
    //}}AFX_MSG
...
class ZCUI_PORT CZcUiPlotStyleNamesComboBox : public CZcUiMRUComboBox {
    ...
    public:
    //{{AFX_VIRTUAL(CZcUiPlotStyleNamesComboBox)
    //}}AFX_VIRTUAL

    protected:
    //{{AFX_MSG(CZcUiPlotStyleNamesComboBox)
    //}}AFX_MSG
...
public:
    //{{AFX_VIRTUAL(CZcUiPredefBlockComboBox)
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZcUiPredefBlockComboBox)
    //}}AFX_MSG

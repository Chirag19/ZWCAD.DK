...
public:
    ...
    virtual bool                configure                       (const ZCHAR * pszConfigInfo, 
                                                                 bool bShowDialog)              = 0;
    virtual bool                saveSettings                    (void)                          = 0;

    virtual void                driverName                      (ZCHAR * pszPath, 
                                                                 int nStrLen) const             = 0;
    virtual int                 driverVersion                   (void) const                    = 0;
    virtual int                 driverRevision                  (void) const                    = 0;
    virtual void                driverPath                      (ZCHAR *        pszPath, 
                                                                 int            nStrLen) const  = 0;
    virtual void                setDriverPath                   (const ZCHAR *  pszPath)        = 0;

    virtual void                currentDisplayDriver            (ZCHAR *        pszPath,
                                                                 int            nPathStrLen,
                                                                 ZCHAR *        pszDriver,
                                                                 int            nDriverStrLen,
                                                                 bool &         bHardwareAccelerated)  = 0;

    virtual void                hardwareAcceleratedDriver       (ZCHAR *        pszPath,
                                                                 int            nPathStrLen,
                                                                 ZCHAR *        pszDriver,
                                                                 int            nDriverStrLen)  = 0;
    virtual void                setHardwareAcceleratedDriver    (const ZCHAR *  pszPath,
                                                                 const ZCHAR *  pszDriver)      = 0;

    virtual void                defaultHardwareAcceleratedDriver(ZCHAR *        pszPath,
                                                                 int            nPathStrLen,
                                                                 ZCHAR *        pszDriver,
                                                                 int            nDriverStrLen)  = 0;
    virtual void                hardwareAcceleratedDrivers      (ZCHAR *        pszPath,
                                                                 int            nPathStrLen,
                                                                 ZCHAR **       pszDrivers,
                                                                 int            nDrivers)       = 0;

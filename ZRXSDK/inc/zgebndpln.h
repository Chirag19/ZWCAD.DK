...
public:
    ...
    Zdesk::Boolean    intersectWith (const ZcGeLinearEnt3d& linEnt, ZcGePoint3d& point,
                                     const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean    intersectWith (const ZcGePlane& plane, ZcGeLineSeg3d& results,
                                     const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean    intersectWith (const ZcGeBoundedPlane& plane, ZcGeLineSeg3d& result,
                                     const ZcGeTol& tol = ZcGeContext::gTol) const;

...
class ZDESK_NO_VTABLE ZcPlPlotProgress
{
public:
    ...
    virtual bool setStatusMsgString(const ZCHAR *pMsg) = 0;
    virtual bool getStatusMsgString(ZCHAR *& pMsg) const = 0;
...
public:
    ...
    virtual bool setPlotMsgString(PlotMSGIndex index, const ZCHAR *pMsg) = 0;
    virtual bool getPlotMsgString(PlotMSGIndex index, ZCHAR *& pMsg) const = 0;

...
public:
    ...
    Zcad::ErrorStatus convertFrom(ZcDbEntity*& pPline, 
                                  Zdesk::Boolean transferId = Zdesk::kTrue);
    Zcad::ErrorStatus convertTo(ZcDb2dPolyline*&  pPline,
                                Zdesk::Boolean transferId = Zdesk::kTrue) const;
    ...
    virtual Zdesk::Boolean onSegAt      (unsigned int index, const ZcGePoint2d& pt2d,
                                         double& param) const;

   
    void              setClosed       (Zdesk::Boolean);
    void              setPlinegen     (Zdesk::Boolean);
    ...
    Zdesk::Boolean    isClosed        ()                        const;      
    Zdesk::Boolean    isOnlyLines     ()                        const;
    Zdesk::Boolean    hasPlinegen     ()                        const;
    ...
    void              reset           (Zdesk::Boolean reuse,
                                       unsigned int numVerts);


    Zdesk::Boolean     hasBulges       ()        const;
    Zdesk::Boolean     hasWidth        ()        const;
...
inline Zdesk::Boolean ZcDbPolyline::isPlanar() const
{
    return Zdesk::kTrue;
}

...
{
    DISPID    m_dispid;
    const ZCHAR * m_ProgID;
    const ZCHAR * m_lpLeftIconRes;
    UINT      m_nLeftIconType;
    const ZCHAR * m_lpEllipsisBmpRes;
...
struct CATCMDBTN_ENTRY
{
    PROPCAT     m_CatID;
    UINT        m_nBtnNameId;
    const ZCHAR * m_lpEnBtnBmpRes;
    UINT        m_nEnBtnBmpType;
    const ZCHAR * m_lpDisBtnBmpRes;

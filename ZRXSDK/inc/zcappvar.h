...
public:
    ...
    Zcad::ErrorStatus setCoords(Zdesk::Int16 value, bool bUndo = false);
    inline Zdesk::Int16 coords() const;

    Zcad::ErrorStatus setDelUsedObj(Zdesk::Int16, bool bUndo = false);
    inline Zdesk::Int16 delUsedObj() const;

    Zcad::ErrorStatus setDragmode(Zdesk::Int16, bool bUndo = false);
    inline Zdesk::Int16 dragmode() const;

    Zcad::ErrorStatus setOsmode(Zdesk::Int16 value, bool bUndo = false);
    inline Zdesk::Int16 osmode() const;

    Zcad::ErrorStatus setPickstyle(Zdesk::Int16 value, bool bUndo = false);
    inline Zdesk::Int16 pickstyle() const;
...
inline Zdesk::Int16 ZcDbAppSystemVariables::coords() const
{
    return m_coords;
}


inline Zdesk::Int16 ZcDbAppSystemVariables::delUsedObj() const
{
    return m_delobj;
}


inline Zdesk::Int16 ZcDbAppSystemVariables::dragmode() const
{
    return m_dragmode;
}


inline Zdesk::Int16 ZcDbAppSystemVariables::osmode() const
{
    return m_osmode;
}


inline Zdesk::Int16 ZcDbAppSystemVariables::pickstyle() const
{
    return m_pkstyle;
}

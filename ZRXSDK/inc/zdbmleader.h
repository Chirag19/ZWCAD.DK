...
const int ZMAX_LEADER_NUMBER     = 5000;
const int ZMAX_LEADERLINE_NUMBER = 5000;
...
public:
    ...
    enum gsMarkType {
        ...
        kLeaderLineMark     = kArrowMark  + ZMAX_LEADERLINE_NUMBER,

        kDoglegMark         = kLeaderLineMark + ZMAX_LEADERLINE_NUMBER,

        kMTextMark          = kDoglegMark + ZMAX_LEADER_NUMBER,
    ...
    virtual Zcad::ErrorStatus highlight                   (const ZcDbFullSubentPath& subId = kNullSubent,
                                                           const Zdesk::Boolean highlightAll = false) const;

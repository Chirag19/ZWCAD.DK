...
public:
    //{{AFX_VIRTUAL(CZdUiOwnerDrawButton)
    public:
...
public:
    //{{AFX_VIRTUAL(CZdUiBitmapButton)
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZdUiBitmapButton)
    //}}AFX_MSG
...
public:
    //{{AFX_VIRTUAL(CZdUiBitmapStatic)
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZdUiBitmapStatic)
    //}}AFX_MSG
...
public:
    //{{AFX_VIRTUAL(CZdUiDropSite)
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZdUiDropSite)
    //}}AFX_MSG
...
public:
    //{{AFX_VIRTUAL(CZdUiToolButton)
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZdUiToolButton)
    //}}AFX_MSG

...
dictionaryNameAt(ZCHAR*& pName, ZcDbObjectId itemId, ZcDbObjectId ownerDictId)
{
...
inline Zcad::ErrorStatus 
dictionaryNameAt(ZCHAR*& pName, ZcDbObjectId itemId)
{
...
inline Zcad::ErrorStatus
dictionaryGetAt(ZcDbObjectId& id, const ZCHAR* name, ZcDbObjectId ownerDictId)
{
...
inline Zcad::ErrorStatus \
get##UPPERNAME##Id(ZcDbObjectId& id, const ZCHAR* name, ZcDbDatabase* pDb) \
{ \
    assert(pDb != NULL); \
    return (pDb != NULL) \
...
inline Zcad::ErrorStatus \
get##UPPERNAME##Name(ZCHAR*& name, ZcDbObjectId itemId) \
{ \
...
inline bool \
has##UPPERNAME(const ZCHAR* name, ZcDbDatabase* pDb) \
{ \
    ZcDbObjectId id; \

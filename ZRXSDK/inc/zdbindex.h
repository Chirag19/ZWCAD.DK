...
public:
	...
	Zdesk::Boolean isUptoDate   () const;  
...
public:
    ...
    virtual Zcad::ErrorStatus accepts(ZcDbObjectId id, 
                      Zdesk::Boolean& idPassesFilter) const = 0;

 
    virtual Zdesk::Boolean    buffersForComposition() const;
...
class ZcDbIndexUpdateData 
{
    public:
        ...
        Zcad::ErrorStatus setIdFlags (ZcDbObjectId id, Zdesk::UInt8 flags);
        
        Zcad::ErrorStatus setIdData  (ZcDbObjectId id, Zdesk::ULongPtr data);
        
        Zcad::ErrorStatus getIdData       (ZcDbObjectId id, Zdesk::ULongPtr& data)  const;
        Zcad::ErrorStatus getIdFlags      (ZcDbObjectId id, Zdesk::UInt8&  flags) const;       
        Zcad::ErrorStatus getFlagsAndData (ZcDbObjectId   id, 
                                           Zdesk::UInt8&  flags, 
                                           Zdesk::ULongPtr& data) const;
...
public:
    ...
    Zcad::ErrorStatus    setCurIdInfo (Zdesk::UInt8   flags,  
                                       Zdesk::ULongPtr data);

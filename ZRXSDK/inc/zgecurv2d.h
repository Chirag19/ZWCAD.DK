...
public:
    ...
    Zdesk::Boolean getNormalPoint (const ZcGePoint2d& pnt,
	                           ZcGePointOnCurve2d& pntOnCrv,
                                   const ZcGeTol& tol = ZcGeContext::gTol) const;
    ...
    Zdesk::Boolean isOn(const ZcGePoint2d& pnt,
                        const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean isOn(const ZcGePoint2d& pnt, double& param,
                        const ZcGeTol& tol = ZcGeContext::gTol) const;
    ...
    Zdesk::Boolean isLinear  (ZcGeLine2d& line,
                              const ZcGeTol& tol = ZcGeContext::gTol) const;
    ...
    Zdesk::Boolean isDegenerate(ZcGe::EntityId& degenerateType,
                                const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean isDegenerate(ZcGeEntity2d*& pConvertedEntity,
                                const ZcGeTol& tol = ZcGeContext::gTol) const;
    ...
    Zdesk::Boolean hasStartPoint(ZcGePoint2d& startPoint) const;
    Zdesk::Boolean hasEndPoint  (ZcGePoint2d& endPoint) const;

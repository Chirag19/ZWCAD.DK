...
#ifdef ZC_GEVEC3D_H
inline Autodesk::AutoCAD::Geometry::Vector3d ToVector3d(const ZcGeVector3d& pt)
{
...
#ifdef ZC_GEVEC2D_H
inline Autodesk::AutoCAD::Geometry::Vector2d ToVector2d(const ZcGeVector2d& pt)
{
...
#ifdef ZC_GEMAT2D_H
inline Autodesk::AutoCAD::Geometry::Matrix3d ToMatrix3d(const ZcGeMatrix3d& pt)
{
...
#ifdef ZC_GEMAT3D_H
inline Autodesk::AutoCAD::Geometry::Matrix2d ToMatrix2d(const ZcGeMatrix2d& pt)
{
...
#ifdef ZC_GEPNT3D_H
inline Autodesk::AutoCAD::Geometry::Point3d ToPoint3d(const ZcGePoint3d& pt)
{
...
#ifdef ZC_GEPNT2D_H
inline Autodesk::AutoCAD::Geometry::Point2d ToPoint2d(const ZcGePoint2d& pt)
{
...
#ifdef ZC_GESCL2D_H
inline Autodesk::AutoCAD::Geometry::Scale2d ToScale2d(const ZcGeScale2d& pt)
{
...
#ifdef ZC_GESCL3D_H
inline Autodesk::AutoCAD::Geometry::Scale3d ToScale3d(const ZcGeScale3d& pt)
{
...
#ifdef ZC_GETOL_H
inline Autodesk::AutoCAD::Geometry::Tolerance ToTolerance(const ZcGeTol& pt)
{
...
#ifdef _ZD_DBID_H
inline Autodesk::AutoCAD::DatabaseServices::ObjectId ToObjectId(const ZcDbObjectId& pt)
{
...
#ifdef ZD_DBMAIN_H
inline Autodesk::AutoCAD::DatabaseServices::Extents3d ToExtents3d(const ZcDbExtents& pt)
{
    Autodesk::AutoCAD::DatabaseServices::Extents3d ret;
    ZGETEXTENTS3D(ret) = pt;
    return ret;
}
#endif

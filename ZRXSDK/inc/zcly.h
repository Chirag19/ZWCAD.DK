...
{
public:
    virtual const ZCHAR * getVariable() const = 0;
    virtual const ZCHAR * getConstant() const = 0;
};
...
public:
    ...
    virtual const ZCHAR * name() const;
    virtual Zcad::ErrorStatus setName(const ZCHAR *);
    virtual bool allowRename() const;

    virtual Zcad::ErrorStatus getImages(HIMAGELIST& imageList, Zdesk::UInt32& normalImage, Zdesk::UInt32& selected) const;
    ...
    virtual const ZCHAR * filterExpression() const;
    virtual Zcad::ErrorStatus setFilterExpression(const ZCHAR * expr);

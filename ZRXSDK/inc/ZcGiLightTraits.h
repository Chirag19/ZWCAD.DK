...
public:
    ...
    virtual bool setShadowMapSize(Zdesk::UInt16 sz);

    virtual Zdesk::UInt16 shadowMapSize() const;

    virtual bool setShadowMapSoftness(Zdesk::UInt8 soft);

    virtual Zdesk::UInt8 shadowMapSoftness() const;

private:
    bool            mShadowsOn;
    ShadowType      mShadowType;
    Zdesk::UInt16   mShadowMapSize;
    Zdesk::UInt8    mShadowMapSoftness;
};
...
public:
    ...
    virtual bool setShadowSamples(Zdesk::UInt16 samples);

    virtual Zdesk::UInt16 shadowSamples() const;
...
public:
    ...
    bool setSolarDiskSamples(Zdesk::UInt16 samples) { return setSolarDiskSamplesImp(samples); }

    Zdesk::UInt16 solarDiskSamples() const { return solarDiskSamplesImp(); }
...
protected:
    ...
    virtual bool setSolarDiskSamplesImp (Zdesk::UInt16 samples);
    virtual Zdesk::UInt16 solarDiskSamplesImp (void) const;
...
private:
    ...
    Zdesk::UInt16   mSolarDiskSamples;
...
public:
    ...
    virtual void setWebFile(const ZCHAR* webFile) = 0;

...
const ZCHAR ZCDB_MOTIONPATH_DICTIONARY[]  = ZCRX_T("ZCAD_MOTION");
...
public:
    ...
    Zdesk::UInt32       frames() const;
    Zcad::ErrorStatus   setFrames(Zdesk::UInt16 frames);

    Zdesk::UInt32       frameRate() const;
    Zcad::ErrorStatus   setFrameRate(Zdesk::UInt16 rate);

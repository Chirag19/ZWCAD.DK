...
class ZcDbImpObjectReactor;
class ZcDbImpDatabaseReactor;
...
extern const ZcDbFullSubentPath kNullSubent;
...
bool   zcdbDisplayPreviewFromDwg(const ZCHAR *pszDwgfilename,
                                 void* pPreviewWnd,
                                 const Zdesk::UInt32* pBgColor = NULL);
...
Zcad::ErrorStatus ZDESK_STDCALL
zcdbOpenZcDbObject(ZcDbObject*& pObj, ZcDbObjectId id, ZcDb::OpenMode mode,
...
Zcad::ErrorStatus zcdbLoadMlineStyleFile(
                const ZCHAR *sname, const ZCHAR *fname);

Zcad::ErrorStatus zcdbLoadLineTypeFile(const ZCHAR *ltname,
                                       const ZCHAR *fname,
                                       ZcDbDatabase *pDb);
...
#define zcdbAlloc(a) zcdbAlloc_dbg(a, __FILE__, __LINE__)
#define zcdbRealloc(a, b) zcdbRealloc_dbg(a, b, __FILE__, __LINE__)
#endif
void  zcdbFree(void*);
...
const ZCHAR* zcdbOriginalXrefFullPathFor(const ZcDbDatabase*);

ZcGiContext * zcdbSetDefaultZcGiContext(ZcGiContext *);

Zcad::ErrorStatus 
zcdbGetThumbnailBitmapFromDxfFile(const ZCHAR* filename, void*& pBitmap);

Zcad::ErrorStatus zcdbSaveAs2004(ZcDbDatabase* pDb, const ZCHAR* fileName);

Zcad::ErrorStatus zcdbSaveAs2000(ZcDbDatabase* pDb, const ZCHAR* fileName);

Zcad::ErrorStatus zcdbDxfOutAs2004(ZcDbDatabase* pDb, const ZCHAR* fileName,
                                         const int precision = 16);
Zcad::ErrorStatus zcdbDxfOutAs2000(ZcDbDatabase* pDb, const ZCHAR* fileName,
                                         const int precision = 16);
Zcad::ErrorStatus zcdbDxfOutAsR12(ZcDbDatabase* pDb, const ZCHAR* fileName,
                                         const int precision = 16);
Zcad::ErrorStatus zcdbSaveAsR14(ZcDbDatabase* pDb, const ZCHAR* fileName);


class ZDESK_NO_VTABLE ZcDbServices: public ZcRxService
{
public:
...
public:
	...
	ZcDbDatabase(ZcDbImpDatabase* pDbImp);
    ...
    Zcad::ErrorStatus getZcDbObjectId(ZcDbObjectId& retId,
                                      ...
                                      Zdesk::UInt32 xRefId = 0);
    const ZCHAR* classDxfName(const ZcRxClass* pClass);

    Zcad::ErrorStatus readDwgFile(const ZCHAR* fileName,
    ...
    Zcad::ErrorStatus readDwgFile(ZcDwgFileHandle *pDwgFile,
                                  bool bAllowCPConversion = false,
                                  const wchar_t* wszPassword = NULL);
    Zcad::ErrorStatus saveAs(const ZCHAR* fileName,
                             const ZSecurityParams* pSecParams = 0);
    Zcad::ErrorStatus save();
    Zcad::ErrorStatus dxfIn(const ZCHAR* dxfFilename,
                            const ZCHAR* logFilename=NULL);
    Zcad::ErrorStatus dxfOut(const ZCHAR* fileName,
                             const int precision = 16,
    ...
    Zdesk::Int32 numberOfSaves() const;
    const ZCHAR * originalFileName() const;
    ...
    Zcad::ErrorStatus wblock(ZcDbDatabase* pOutputDb,  // pre-existing (template) db
                             const ZcDbObjectIdArray& outObjIds,
                             const ZcGePoint3d& basePoint,
                             ZcDb::DuplicateRecordCloning drc);  // kDrcIgnore
    ...
    Zcad::ErrorStatus insert(ZcDbObjectId& blockId, const ZCHAR* pBlockName,
        ZcDbDatabase* pDb,
    ...
    Zcad::ErrorStatus insert(ZcDbObjectId& blockId, 
        const ZCHAR* pSourceBlockName,
        const ZCHAR* pDestinationBlockName,
        ZcDbDatabase* pDb,
        bool preserveSourceDatabase = true);
    ...
    Zdesk::UInt8      maintenanceReleaseVersion() const;
    ...
    bool                  setSecurityParams(const ZSecurityParams* pSecParams,
                                            bool bSetDbMod = true);
    const ZSecurityParams* cloneSecurityParams();
    static void           disposeSecurityParams(const ZSecurityParams* pSecParams);
    ...
    Zdesk::Int16 saveproxygraphics() const;
    Zcad::ErrorStatus setSaveproxygraphics(Zdesk::Int16 saveimg);

    Zdesk::Int16 delUsedObj() const;
    Zcad::ErrorStatus setDelUsedObj(Zdesk::Int16 deleteObj);
    ...
    Zdesk::Int16 dragmode() const;
    Zcad::ErrorStatus setDragmode(Zdesk::Int16 mode);

    Zdesk::Int16 treedepth() const;
    Zcad::ErrorStatus setTreedepth(Zdesk::Int16 depth);

    Zdesk::Int16 lunits() const;
    Zcad::ErrorStatus setLunits(Zdesk::Int16 lunits);

    Zdesk::Int16 luprec() const;
    Zcad::ErrorStatus setLuprec(Zdesk::Int16 prec);

    Zdesk::Int16 aunits() const;
    Zcad::ErrorStatus setAunits(Zdesk::Int16 aunits);

    Zdesk::Int16 auprec() const;
    Zcad::ErrorStatus setAuprec(Zdesk::Int16 auprec);

    Zdesk::Int16 attmode() const;
    Zcad::ErrorStatus setAttmode(Zdesk::Int16 mode);

    Zdesk::Int16 coords() const;
    Zcad::ErrorStatus setCoords(Zdesk::Int16 coords);

    Zdesk::Int16 pdmode() const;
    Zcad::ErrorStatus setPdmode(Zdesk::Int16 mode);

    Zdesk::Int16 pickstyle() const;
    Zcad::ErrorStatus setPickstyle(Zdesk::Int16 style);

    Zdesk::Int16 useri1() const;
    Zcad::ErrorStatus setUseri1(Zdesk::Int16 val);

    Zdesk::Int16 useri2() const;
    Zcad::ErrorStatus setUseri2(Zdesk::Int16 val);

    Zdesk::Int16 useri3() const;
    Zcad::ErrorStatus setUseri3(Zdesk::Int16 val);

    Zdesk::Int16 useri4() const;
    Zcad::ErrorStatus setUseri4(Zdesk::Int16 val);

    Zdesk::Int16 useri5() const;
    Zcad::ErrorStatus setUseri5(Zdesk::Int16 val);

    Zdesk::Int16 splinesegs() const;
    Zcad::ErrorStatus setSplinesegs(Zdesk::Int16 segs);

    Zdesk::Int16 surfu() const;
    Zcad::ErrorStatus setSurfu(Zdesk::Int16 u);

    Zdesk::Int16 surfv() const;
    Zcad::ErrorStatus setSurfv(Zdesk::Int16 v);

    Zdesk::Int16 surftype() const;
    Zcad::ErrorStatus setSurftype(Zdesk::Int16 type);

    Zdesk::Int16 surftab1() const;
    Zcad::ErrorStatus setSurftab1(Zdesk::Int16 tab1);

    Zdesk::Int16 surftab2() const;
    Zcad::ErrorStatus setSurftab2(Zdesk::Int16 tab2);

    Zdesk::Int16 splinetype() const;
    Zcad::ErrorStatus setSplinetype(Zdesk::Int16 type);

    Zdesk::Int16 shadedge() const;
    Zcad::ErrorStatus setShadedge(Zdesk::Int16 mode);

    Zdesk::Int16 shadedif() const;
    Zcad::ErrorStatus setShadedif(Zdesk::Int16 dif);

    ZcDb::MeasurementValue measurement() const;
    Zcad::ErrorStatus setMeasurement(ZcDb::MeasurementValue type);

    Zdesk::Int16 unitmode() const;
    Zcad::ErrorStatus setUnitmode(Zdesk::Int16 mode);

    Zdesk::Int16 maxactvp() const;
    Zcad::ErrorStatus setMaxactvp(Zdesk::Int16 max);

    Zdesk::Int16 isolines() const;
    Zcad::ErrorStatus setIsolines(Zdesk::Int16 isolines);
    
    Zdesk::UInt8 dwfframe() const;
    Zcad::ErrorStatus setDwfframe(Zdesk::UInt8);
    
    Zdesk::UInt8 dgnframe() const;
    Zcad::ErrorStatus setDgnframe(Zdesk::UInt8);
    ...
    Zcad::ErrorStatus getMenu(ZCHAR*& pOutput) const;
    ...
    const ZcDbDate tdcreate() const;     // returns a local time
    const ZcDbDate tdupdate() const;

    const ZcDbDate tducreate() const;    // returns a universal time
    const ZcDbDate tduupdate() const;

    const ZcDbDate tdindwg() const;      // returns a time delta
    ...
    Zdesk::Int16 cmljust() const;
    Zcad::ErrorStatus setCmljust(Zdesk::Int16 just);
    ...
    #undef ZDBDIMVAR_H                   // force the file to get read again
    #include "zdbdimvar.h"
    ...
    Zcad::ErrorStatus loadLineTypeFile(const ZCHAR *ltn, const ZCHAR *filename);

    Zcad::ErrorStatus getProjectName(ZCHAR*& pOutput) const;
    Zcad::ErrorStatus setProjectName(const ZCHAR*);
    Zcad::ErrorStatus getHyperlinkBase(ZCHAR*& pOutput) const;
    Zcad::ErrorStatus setHyperlinkBase(const ZCHAR*);
    Zcad::ErrorStatus getStyleSheet(ZCHAR*& pOutput) const;
    Zcad::ErrorStatus setStyleSheet(const ZCHAR*);
    Zcad::ErrorStatus getFilename(const ZCHAR* & pOutput) const;
    ...
    Zcad::ErrorStatus getFingerprintGuid(ZCHAR*& guidString) const;
    Zcad::ErrorStatus setFingerprintGuid(const ZCHAR *pNewGuid);

    Zcad::ErrorStatus getVersionGuid(ZCHAR*& guidString) const;
    Zcad::ErrorStatus setVersionGuid(const ZCHAR *pNewGuid);
    ...
    Zdesk::UInt8        sortEnts() const;
    Zcad::ErrorStatus   setSortEnts(Zdesk::UInt8 sortEnts);

    Zdesk::UInt8        drawOrderCtl() const;
    Zcad::ErrorStatus   setDrawOrderCtl(Zdesk::UInt8 val);
    
    Zdesk::UInt8        dimAssoc() const;
    Zcad::ErrorStatus setDimAssoc(Zdesk::UInt8 val);

    Zdesk::UInt8 hideText() const;
    Zcad::ErrorStatus setHideText(Zdesk::UInt8 val);

    Zdesk::UInt8  haloGap() const;
    Zcad::ErrorStatus setHaloGap(Zdesk::UInt8 val);

    Zdesk::UInt16 obscuredColor() const;
    Zcad::ErrorStatus setObscuredColor(Zdesk::UInt16 val);

    Zdesk::UInt8 obscuredLineType() const;
    Zcad::ErrorStatus setObscuredLineType(Zdesk::UInt8 val);

    Zdesk::UInt8  intersectDisplay() const;
    Zcad::ErrorStatus setIntersectDisplay(Zdesk::UInt8 val);

    Zdesk::UInt16 intersectColor() const;
    Zcad::ErrorStatus setIntersectColor(Zdesk::UInt16 val);
    ...
    Zcad::ErrorStatus getVisualStyleList(ZcArray<const ZCHAR*> & vstyleList);

    Zdesk::UInt8  solidHist() const;
    Zcad::ErrorStatus setSolidHist(Zdesk::UInt8 val);

    Zdesk::UInt8  showHist() const;
    Zcad::ErrorStatus setShowHist(Zdesk::UInt8 val);
    ...
    Zdesk::UInt16 loftParam() const;
    Zcad::ErrorStatus setLoftParam(Zdesk::UInt16 flags);
    Zdesk::UInt8 loftNormals() const;
    Zcad::ErrorStatus setLoftNormals(Zdesk::UInt8 value);
    ...
    Zdesk::UInt8 lightGlyphDisplay() const;
    Zcad::ErrorStatus setLightGlyphDisplay(Zdesk::UInt8 val);
    Zdesk::UInt8 tileModeLightSynch() const;
    Zcad::ErrorStatus setTileModeLightSynch(Zdesk::UInt8 val);
    ...
    Zdesk::UInt8 cshadow() const;
    Zcad::ErrorStatus setCshadow(Zdesk::UInt8 val);
    ...
    Zcad::ErrorStatus setAnnotativeDwg(bool anno);

    bool msltscale() const;
    Zcad::ErrorStatus setMsltscale(bool val);

    Zdesk::UInt8 lightingUnits() const;
    Zcad::ErrorStatus setLightingUnits(Zdesk::UInt8 val);

    bool lightsInBlocks() const;
    Zcad::ErrorStatus setLightsInBlocks(bool val);

    Zdesk::Int16 dxeVal() const;
    Zcad::ErrorStatus setDxeVal(Zdesk::Int16 val);
...
public:
	ZcDbObjectIterator(void * pIterImp);
};


class ZDESK_NO_VTABLE ZcDbObject: public ZcGiDrawable, public ZcHeapOperators
{
public:
    ...
    Zcad::ErrorStatus upgradeFromNotify(Zdesk::Boolean& wasWritable);
    Zcad::ErrorStatus downgradeOpen();
    Zcad::ErrorStatus downgradeToNotify(Zdesk::Boolean wasWritable);
    ...
    Zcad::ErrorStatus closeAndPage(Zdesk::Boolean onlyWhenClean = true);
    virtual Zcad::ErrorStatus subClose();

    Zcad::ErrorStatus erase(Zdesk::Boolean erasing = true);
    virtual Zcad::ErrorStatus subErase(Zdesk::Boolean erasing);

    Zcad::ErrorStatus handOverTo(ZcDbObject* newObject,
                                 Zdesk::Boolean keepXData = true,
                                 Zdesk::Boolean keepExtDict = true);
    ...
    Zcad::ErrorStatus         dxfOut      (ZcDbDxfFiler* pFiler,
                                           Zdesk::Boolean allXdFlag,
                                           Zdesk::uchar* regAppTable) const;
    ...
    virtual resbuf*           xData   (const ZCHAR* regappName = NULL) const;
    virtual Zcad::ErrorStatus setXData(const resbuf* xdata);
            Zcad::ErrorStatus xDataTransformBy(const ZcGeMatrix3d& xform);

    
    Zcad::ErrorStatus         setBinaryData(const ZCHAR * key,
                                            long         size,
                                            const char * data);
    Zcad::ErrorStatus         getBinaryData(const ZCHAR * key,
                                            long &       size,
                                            char *&      data) const;

    
    Zdesk::Boolean isEraseStatusToggled() const;
    Zdesk::Boolean isErased() const;
    Zdesk::Boolean isReadEnabled() const;
    Zdesk::Boolean isWriteEnabled() const;
    Zdesk::Boolean isNotifyEnabled() const;
    Zdesk::Boolean isModified() const;
    Zdesk::Boolean isModifiedXData() const;
    Zdesk::Boolean isModifiedGraphics() const;
    Zdesk::Boolean isNewObject() const;
    Zdesk::Boolean isNotifying() const;
    Zdesk::Boolean isUndoing() const;
    Zdesk::Boolean isCancelling() const;
    Zdesk::Boolean isReallyClosing() const;
    Zdesk::Boolean isTransactionResident() const;

    
    Zdesk::Boolean isAProxy() const;

    
    void assertReadEnabled() const;
    void assertWriteEnabled(Zdesk::Boolean autoUndo = true,
                            Zdesk::Boolean recordModified = true);
    void assertNotifyEnabled() const;

    
    void                      disableUndoRecording(Zdesk::Boolean disable);
    ...
    virtual Zcad::ErrorStatus deepClone(ZcDbObject* pOwnerObject,
                                        ...
                                        ZcDbIdMapping& idMap,
                                        Zdesk::Boolean isPrimary = true) const;
    ...
    Zdesk::Boolean    isZcDbObjectIdsInFlux() const;
    ...
    virtual Zdesk::Boolean      isPersistent() const;
    ...
    Zcad::ErrorStatus getField(const ZCHAR* pszPropName, 
                               ZcDbObjectId& fieldId) const;
    Zcad::ErrorStatus getField(const ZCHAR* pszPropName, ZcDbField*& pField,
                               ZcDb::OpenMode mode) const;

    virtual Zcad::ErrorStatus setField(const ZCHAR* pszPropName, ZcDbField* pField,
                               ZcDbObjectId& fieldId);

    virtual Zcad::ErrorStatus removeField(ZcDbObjectId fieldId);
    virtual Zcad::ErrorStatus removeField(const ZCHAR* pszPropName, ZcDbObjectId& returnId);
    virtual Zcad::ErrorStatus removeField(const ZCHAR* pszPropName);
...
class ZDESK_NO_VTABLE ZcDbXObject: public ZcRxObject
...
public:
    ...
    virtual Zcad::ErrorStatus getDescription(ZCHAR*& desc) const;
    virtual Zcad::ErrorStatus getExplanation(ZCHAR*& expl) const;
...
public:
    ...
    Zcad::ErrorStatus getDescription(ZCHAR*& desc) const;
    Zcad::ErrorStatus getExplanation(ZCHAR*& expl) const;
    ...
    void                      getDictionaryKey(ZCHAR *) const;
    Zcad::ErrorStatus         setNamesFromDictionaryKey(const ZCHAR *);
    ...
    static const Zdesk::UInt16 MaxColorIndex; 

    
    ZcCmComplexColor* complexColor() const;
    void setComplexColor(ZcCmComplexColor* pComplex);

    Zcad::ErrorStatus dwgInAsTrueColor(ZcDbDwgFiler* pInputFiler); // For internal use only
    Zcad::ErrorStatus dwgOutAsTrueColor(ZcDbDwgFiler *pOutputFiler) const; // For internal use only
...
private:
    ...
    static const Zdesk::UInt16 ComplexColorFlag; 
...
Zcad::ErrorStatus zccmGetColorFromACIName(ZcCmColor& clr, const ZCHAR *pInput);
Zcad::ErrorStatus zccmGetColorFromRGBName(ZcCmColor& clr, const ZCHAR *pInput);
Zcad::ErrorStatus zccmGetColorFromColorBookName(ZcCmColor& clr, const ZCHAR *pBookName, const ZCHAR *pColorName);


void zccmGetLocalizedColorNames( const ZCHAR* colors[9] );
...
class ZDESK_NO_VTABLE ZcDbEntity: public ZcDbObject
{
public:
    ...
    Zdesk::UInt16               colorIndex() const;
    virtual Zcad::ErrorStatus   setColorIndex(Zdesk::UInt16 color,
                                  Zdesk::Boolean doSubents = true);
    ...
    virtual Zcad::ErrorStatus   setPlotStyleName(const ZCHAR* newName,
                                  Zdesk::Boolean doSubents = true);
    ...
    ZCHAR*                        material() const;
    ZcDbObjectId                materialId() const;
    virtual Zcad::ErrorStatus   setMaterial(const ZCHAR* newVal, Zdesk::Boolean doSubents = true);
    virtual Zcad::ErrorStatus   setMaterial(ZcDbObjectId newVal, Zdesk::Boolean doSubents = true);

    virtual Zcad::ErrorStatus getMaterialMapper(ZcGiMapper& mapper) const;
    virtual Zcad::ErrorStatus setMaterialMapper(const ZcGiMapper& mapper, Zdesk::Boolean doSubents = true);
    ...
    virtual Zdesk::Boolean      isPlanar() const { return false; }
    ...
    virtual Zcad::ErrorStatus highlight(const ZcDbFullSubentPath& subId 
                                        = kNullSubent, const Zdesk::Boolean highlightAll 
                        = false) const;
    ...
    void                        recordGraphicsModified(
                                    Zdesk::Boolean setModified = true);
    ...
    virtual Zdesk::Boolean      cloneMeForDragging();
...
class ZDESK_NO_VTABLE ZcDbObjectReactor: public ZcRxObject
{
public:
...
public:
	...
	ZcDbImpObjectReactor* mpImp;
};

class ZDESK_NO_VTABLE ZcDbEntityReactor: public ZcDbObjectReactor
{
public:
...
class ZDESK_NO_VTABLE ZcDbDatabaseReactor: public ZcRxObject
{
public:
    ...
    virtual void objectErased         (const ZcDbDatabase* dwg, const ZcDbObject* dbObj,
                                        Zdesk::Boolean pErased = true);
    virtual void headerSysVarWillChange(const ZcDbDatabase* dwg, const ZCHAR* name);
    virtual void headerSysVarChanged   (const ZcDbDatabase* dwg, const ZCHAR* name,
                                        Zdesk::Boolean bSuccess);
...
public:
    ...
    ZcGePoint3d       minPoint() const; 
    ZcGePoint3d       maxPoint() const;
...
bool zcdbTextFind(ZcDbDatabase* pDatabase,
                  ...
                  const ZCHAR* findString,
                  const ZCHAR* replaceString = NULL,
                  Zdesk::UInt8 searchOptions = ZC_SRCH_DEFAULT,

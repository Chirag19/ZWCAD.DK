...
#define ZCRX_CMD_MAINTHRD       0x04000000 
...
public:
    ...
    virtual Zdesk::Int32    commandFlags() const = 0;
    ...
    virtual const ZCHAR *   globalName() const = 0;
    virtual const ZCHAR *   localName() const = 0;
...
public:
    ...
    virtual const ZCHAR *      commandGroup() const = 0;
};
...
public:
    ...
    virtual bool              atPut(const ZCHAR * cmdGroupName,
                                    ZcRxDictionary*& cmdsGlobal,
                                    ZcRxDictionary*& cmdsLocal) = 0;

    virtual Zcad::ErrorStatus addCommand(const ZCHAR * cmdGroupName,
                                         const ZCHAR * cmdGlobalName,
                                         const ZCHAR * cmdLocalName,
                                         Zdesk::Int32 commandFlags,
    ...
    virtual ZcEdCommand* lookupGlobalCmd(const ZCHAR * cmdName) = 0;
    virtual ZcEdCommand* lookupLocalCmd(const ZCHAR * cmdName) = 0;
    virtual ZcEdCommand* lookupCmd(const ZCHAR * cmdName,
                                   bool globalFlag) = 0;
    virtual ZcEdCommand* lookupCmd(const ZCHAR * cmdName,
                                   bool globalFlag,
    ...
    virtual ZcEdCommand* lookupCmd(const ZCHAR * cmdName,
                                   ...
                                   bool allGroupsFlag,
                                   bool skipUndefed) = 0;
    virtual ZcEdCommand* lookupCmd2(const ZCHAR * cmdName,
                                   bool globalFlag,
                                   bool allGroupsFlag,
                                   int skipFlags,
                                   bool match = false) = 0;

    virtual Zcad::ErrorStatus popGroupToTop(const ZCHAR * cmdGroupName) = 0;

    virtual Zcad::ErrorStatus removeCmd(const ZCHAR * cmdGroupName,
                                        const ZCHAR * cmdGlobalName) = 0;

    virtual Zcad::ErrorStatus removeGroup(const ZCHAR * groupName) = 0;

...
// Overrides
    ...
    //{{AFX_VIRTUAL(CZdUiDockControlBar)
    protected:
...
public:
    //{{AFX_VIRTUAL(CZdUiDockFrame)
    protected:
    virtual BOOL PreCreateWindow(CREATESTRUCT& cs);
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(CZdUiDockFrame)
    afx_msg int OnCreate(LPCREATESTRUCT lpCreateStruct);
...
public:
    //{{AFX_VIRTUAL(CZdUiPaletteSetDockFrame)
    protected:
    virtual BOOL PreCreateWindow(CREATESTRUCT& cs);
    //}}AFX_VIRTUAL
...
protected:
    ...
    //{{AFX_MSG(CZdUiPaletteSetDockFrame)
    afx_msg int     OnCreate(LPCREATESTRUCT lpCreateStruct);

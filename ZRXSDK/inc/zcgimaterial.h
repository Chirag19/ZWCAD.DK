...
public:
    ...
    ZCGIMAT_IMPEXP ZcGiMaterialColor             (void);
    ZCGIMAT_IMPEXP virtual ~ZcGiMaterialColor    (void);

    ZCGIMAT_IMPEXP ZcGiMaterialColor             (const ZcGiMaterialColor &matColor);
    ZCGIMAT_IMPEXP ZcGiMaterialColor & operator= (const ZcGiMaterialColor &matColor);
    ZCGIMAT_IMPEXP bool                operator==(const ZcGiMaterialColor &matColor)const;

    ZCGIMAT_IMPEXP virtual void set       (const ZcGiMaterialColor &matColor);
    ZCGIMAT_IMPEXP virtual void setMethod (Method method);
    ZCGIMAT_IMPEXP virtual void setFactor (double dFactor);
    ZCGIMAT_IMPEXP virtual void setColor  (const ZcCmEntityColor& color);

    ZCGIMAT_IMPEXP virtual Method                  method (void) const;
    ZCGIMAT_IMPEXP virtual double                  factor (void) const;
    ZCGIMAT_IMPEXP virtual const ZcCmEntityColor & color  (void) const;
...
public:
    ...
    virtual void                setSourceFileName (const ZCHAR * fileName);
    virtual const ZCHAR *       sourceFileName    (void) const;
private:
...
public:
    ...
    ZCGIMAT_IMPEXP ZcGiMaterialMap             (void);
    ZCGIMAT_IMPEXP virtual ~ZcGiMaterialMap    (void);

    ZCGIMAT_IMPEXP ZcGiMaterialMap             (const ZcGiMaterialMap &matMap);
    ZCGIMAT_IMPEXP ZcGiMaterialMap & operator= (const ZcGiMaterialMap &matMap);
    ZCGIMAT_IMPEXP bool              operator==(const ZcGiMaterialMap &matMap)const;

    ZCGIMAT_IMPEXP virtual void set               (const ZcGiMaterialMap &matMap);
    ZCGIMAT_IMPEXP virtual void setSource         (Source source);

    ZDESK_DEPRECATED virtual void setSourceFileName (const ZCHAR * fileName);
    ZCGIMAT_IMPEXP virtual void setTexture        (const ZcGiMaterialTexture * pTexture);
    ZCGIMAT_IMPEXP virtual void setBlendFactor    (double blendFactor);
    ZCGIMAT_IMPEXP virtual void setMapper         (const ZcGiMapper &mapper);


    ZCGIMAT_IMPEXP virtual Source                  source         (void) const;

    ZDESK_DEPRECATED virtual const ZCHAR * sourceFileName (void) const;
    ZCGIMAT_IMPEXP virtual const ZcGiMaterialTexture *  texture   (void) const;
    ZCGIMAT_IMPEXP virtual double                  blendFactor    (void) const;
    ZCGIMAT_IMPEXP virtual const ZcGiMapper &      mapper         (void) const;
...
class ZCGIMAT_IMPEXP ZcGiMapper: public ZcRxObject 
{
public:
    ...
    ZDESK_DEPRECATED virtual void setTiling         (Tiling tiling);
    ...
    ZDESK_DEPRECATED virtual    Tiling                 tiling        (void) const;

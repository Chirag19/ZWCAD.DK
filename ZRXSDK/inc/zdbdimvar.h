...
#define ZDBDIMVAR_H
    ...
    virtual const ZCHAR *    dimapost () const;
    ...
    virtual const ZCHAR *    dimpost  () const;
    ...
    virtual Zcad::ErrorStatus setDimapost (const ZCHAR *    v);
    ...
    virtual Zcad::ErrorStatus setDimdsep  (ZCHAR            v);  
    ...
    virtual Zcad::ErrorStatus setDimpost  (const ZCHAR *    v);
    ...
    virtual Zcad::ErrorStatus setDimblk   (const ZCHAR *    v);
    virtual Zcad::ErrorStatus setDimblk1  (const ZCHAR *    v);
    virtual Zcad::ErrorStatus setDimblk2  (const ZCHAR *    v);
    virtual Zcad::ErrorStatus setDimldrblk(const ZCHAR *    v);  

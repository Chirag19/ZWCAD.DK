...
public:
    ...
    virtual void            setImageFilename        (const ZCHAR* filename) = 0;
    virtual const ZCHAR *   imageFilename           (void) const           = 0;
...
public:
    ...
    virtual void setExportMIFileName(const ZCHAR* miName) = 0;
    virtual const ZCHAR* exportMIFileName() const = 0;

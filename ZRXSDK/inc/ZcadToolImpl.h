...
#pragma once
#include "ZcImportXml.h"
using namespace MSXML; 
#include "ZcPExCtl.h"
#include "zopmdialog.h"
#include "Zc64BitHelpers.h"
...
BEGIN_COM_MAP(ZcadToolImpl)
    ...
    COM_INTERFACE_ENTRY(IZPerPropertyBrowsing)
...
protected:
    ...
    struct ZTOOL_MAP_ENTRY
    {
        WCHAR szDesc[512];
        DISPID dispId;
    };
    ZcArray<ZTOOL_MAP_ENTRY> m_ToolMap;
...
public:
    ...
    STDMETHOD(Execute) (/*[in]*/ LONG_PTR lFlag, /*[in]*/ DWORD_PTR /*HWND*/ hWnd, /*[in]*/ DWORD point, /*[in]*/ DWORD dwKeyState)
    {
        ...
        if(!pDb)
            return E_FAIL;
        ZcZxDocLock docLock( pDb, ZcZxDocLock::kNormal );
    ...
    ZcTcCatalog *CreateStockToolATC(LPWSTR szCatalogName)
    {
        ...
        ZcModuleResourceOverride resourceOverride;

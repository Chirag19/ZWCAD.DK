...
public:
    ...
    virtual Zcad::ErrorStatus   subSwapIdWith(
                                    ...
                                    Zdesk::Boolean swapXdata = Zdesk::kFalse,
                                    Zdesk::Boolean swapExtDict = Zdesk::kFalse
                                );
    ...
    virtual Zcad::ErrorStatus   getGsMarkersAtSubentPath(
                                    ...
                                    ZcArray<Zdesk::GsMarker>& gsMarkers
                                ) const;
    ...
    virtual Zdesk::Boolean      freeScanLines(
    ...
    virtual Zdesk::Boolean      setOrientation(
    ...
    virtual ZcGeVector2d        imageSize(Zdesk::Boolean bGetCachedValue
                                        = Zdesk::kFalse) const;

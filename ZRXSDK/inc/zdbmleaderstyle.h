...
public:
    ...
    Zcad::ErrorStatus         setArrowSymbolId              (const ZCHAR* name);
    ...
    Zcad::ErrorStatus         setBlockId                    (const ZCHAR* name);
    ...
    Zcad::ErrorStatus         postMLeaderStyleToDb          (ZcDbDatabase* pDb, const ZCHAR* styleName, ZcDbObjectId & mleaderStyleId);

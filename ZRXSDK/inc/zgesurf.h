...
public:
    ...
    Zdesk::Boolean  isOn           (const ZcGePoint3d& pnt,
                                    const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean  isOn           (const ZcGePoint3d& pnt, ZcGePoint2d& paramPoint,
                                    const ZcGeTol& tol = ZcGeContext::gTol ) const;
    ...
    Zdesk::Boolean  isNormalReversed () const;
    ...
    Zdesk::Boolean isClosedInU       (const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean isClosedInV       (const ZcGeTol& tol = ZcGeContext::gTol) const;

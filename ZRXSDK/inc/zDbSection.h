...
public:
    ...
    ZCDB_PORT const ZCHAR* getName          (void) const;
    ZCDB_PORT Zcad::ErrorStatus getName     (ZcString& sName) const;
    ZCDB_PORT Zcad::ErrorStatus getName     (ZCHAR*& pszName) const;
    ZCDB_PORT Zcad::ErrorStatus setName     (const ZCHAR* pszName);
...
public:
    ...
    ZCDB_PORT virtual Zdesk::Boolean worldDraw(ZcGiWorldDraw* wd);
...
public:
    ...
    ZCDB_PORT const ZCHAR* destinationFile(ZcDbSectionSettings::SectionType nSecType) const;
    ZCDB_PORT Zcad::ErrorStatus setDestinationFile(ZcDbSectionSettings::SectionType nSecType,
        const ZCHAR* pszFileName);
    ...
    ZCDB_PORT const ZCHAR* layer            (ZcDbSectionSettings::SectionType nSecType, 
                                             ZcDbSectionSettings::Geometry nGeometry) const;
    ZCDB_PORT Zcad::ErrorStatus setLayer    (ZcDbSectionSettings::SectionType nSecType, 
                                             ZcDbSectionSettings::Geometry nGeometry, 
                                             const ZCHAR* pszLayer);
    ZCDB_PORT const ZCHAR* linetype         (ZcDbSectionSettings::SectionType nSecType, 
                                             ZcDbSectionSettings::Geometry nGeometry) const;
    ZCDB_PORT Zcad::ErrorStatus setLinetype (ZcDbSectionSettings::SectionType nSecType, 
                                             ZcDbSectionSettings::Geometry nGeometry, 
                                             const ZCHAR* pszLinetype);
    ...
    ZCDB_PORT Zcad::ErrorStatus setLinetypeScale(ZcDbSectionSettings::SectionType nSecType, 
                                             ZcDbSectionSettings::Geometry nGeometry, 
                                             double fScale);
    ZCDB_PORT const ZCHAR* plotStyleName    (ZcDbSectionSettings::SectionType nSecType, 
                                             ZcDbSectionSettings::Geometry nGeometry) const;
    ZCDB_PORT Zcad::ErrorStatus setPlotStyleName(ZcDbSectionSettings::SectionType nSecType, 
                                             ZcDbSectionSettings::Geometry nGeometry, 
                                             const ZCHAR* pszPlotStyleName);

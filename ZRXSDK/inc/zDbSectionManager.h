...
public:
    ...
    ZCDB_PORT Zcad::ErrorStatus getSection  (const ZCHAR* pszName, 
    ...
    ZCDB_PORT Zcad::ErrorStatus getUniqueSectionName(const ZCHAR* pszBaseName, 
                                             ZCHAR*& pszUniqueName) const;

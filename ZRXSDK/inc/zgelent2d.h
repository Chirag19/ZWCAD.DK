...
{
public:
    Zdesk::Boolean   intersectWith  (const ZcGeLinearEnt2d& line, ZcGePoint2d& intPnt,
                                     const ZcGeTol& tol = ZcGeContext::gTol) const;

    Zdesk::Boolean   overlap        (const ZcGeLinearEnt2d& line,
                                     ZcGeLinearEnt2d*& overlap,
                                     const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean   isParallelTo   (const ZcGeLinearEnt2d& line,
                                     const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean   isPerpendicularTo(const ZcGeLinearEnt2d& line,
                                      const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean   isColinearTo   (const ZcGeLinearEnt2d& line,
                                     const ZcGeTol& tol = ZcGeContext::gTol) const;

...
{
public:
    Zdesk::Boolean  intersectWith    (const ZcGeLinearEnt3d& linEnt, ZcGePoint3d& pnt,
    ...
    ZcGePoint3d     closestPointToPlanarEnt (const ZcGePlanarEnt& otherPln,
                                             ...
                                             const ZcGeTol& tol
                                               = ZcGeContext::gTol) const;
    Zdesk::Boolean isParallelTo      (const ZcGeLinearEnt3d& linEnt,
                                      const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean isParallelTo      (const ZcGePlanarEnt& otherPlnEnt,
                                      const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean isPerpendicularTo (const ZcGeLinearEnt3d& linEnt,
                                      const ZcGeTol& tol = ZcGeContext::gTol) const;
    Zdesk::Boolean isPerpendicularTo (const ZcGePlanarEnt& linEnt,
                                      const ZcGeTol& tol = ZcGeContext::gTol) const;

    Zdesk::Boolean isCoplanarTo      (const ZcGePlanarEnt& otherPlnEnt,
                                      const ZcGeTol& tol = ZcGeContext::gTol) const;

...
class __declspec(dllimport) ZcDbObjectId;
#include "zdesk.h"
#include "zaxobjref.h"
#include "zaxboiler.h"
#include "zoleaprot.h"
...
public:
    ...
    virtual ~IZcadBaseObjectImpl()
    {
        ...
        ZcDbObjectPointer<ZcDbObject> pObject(m_objId, ZcDb::kForRead, Zdesk::kTrue);
        if(pObject.openStatus() != Zcad::eOk)
        {
            ZcDbObject* pTemp;
            if (Zcad::eOk != zcdbOpenObject(pTemp,m_objId,ZcDb::kForNotify,Zdesk::kTrue))
            {
                return; 
            }
    ...
    virtual HRESULT CreateNewObject(ZcDbObjectId& objId,
                                ZcDbObjectId& ownerId, ZCHAR* keyName) = 0;
    ...
    STDMETHOD(Clone)(ZcDbObjectId /*ownerId*/, LPUNKNOWN* /*pUnkClone*/)
    {
        return E_NOTIMPL;
    }
...
public:
    ...
    STDMETHOD(get_ObjectID)(Zdesk::IntDbId *pVal)
    {
        *pVal = m_objRef.objectId().asOldId();
        return S_OK;
    }

    STDMETHOD(get_OwnerID)(Zdesk::IntDbId *pVal)
    {
        return ZcAxGetOwnerId(m_objRef, pVal);
    }

#ifdef _WIN64
    STDMETHOD(get_ObjectID32)(Zdesk::Int32 *pVal)
    {
        if(pVal)
    ...
    STDMETHOD(get_OwnerID32)(Zdesk::Int32 *pVal)
    {
        Zdesk::IntDbId objId;

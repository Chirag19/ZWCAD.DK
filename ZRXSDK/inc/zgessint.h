...
public:
    ...
    ZcGeCurve3d*   intCurve (int intNum, Zdesk::Boolean isExternal, ZcGe::ZcGeIntersectError& err) const; 
    ZcGeCurve2d*   intParamCurve(int num, Zdesk::Boolean isExternal, Zdesk::Boolean isFirst, ZcGe::ZcGeIntersectError& err) const;
